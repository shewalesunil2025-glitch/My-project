  ...
  return (
    <div className={cn("relative aspect-square [perspective:1200px]", className)} aria-hidden>
      <motion.div className="absolute inset-0 [transform-style:preserve-3d]" style={{ rotateX, rotateY }}>
        {/* Ambient bloom */}
        <div className="absolute inset-[-25%] rounded-full bg-[radial-gradient(circle,rgb(79_125_255/0.22),transparent_60%)] blur-2xl" />
        ...
        <div className="absolute inset-0 [transform-style:preserve-3d] [transform:rotateX(72deg)]">
          <div className="absolute inset-0 animate-spin-slow rounded-full border border-flow/25">
            <span className="absolute top-1/2 -left-1 size-2 rounded-full bg-flow-soft shadow-[0_0_12px_2px_rgb(122_162_255/0.8)]" />
          </div>
        </div>
        <div className="absolute inset-[9%] [transform-style:preserve-3d] [transform:rotateX(72deg)_rotateY(38deg)]">
          <div className="absolute inset-0 animate-spin-slower rounded-full border border-white/10">
            <span className="absolute -top-1 left-1/2 size-1.5 rounded-full bg-live shadow-[0_0_10px_2px_rgb(94_242_194/0.7)]" />
          </div>
        </div>
        ...
        {/* Sphere */}
        <div className="absolute inset-[30%] rounded-full bg-[radial-gradient(circle_at_32%_28%,#f4f7ff_0%,#a9c1ff_14%,#4f7dff_42%,#152046_72%,#070a12_100%)] shadow-[0_0_60px_10px_rgb(79_125_255/0.35),inset_-12px_-18px_40px_rgb(0_0_0/0.55)]" />
        <div className="absolute inset-[30%] rounded-full bg-[conic-gradient(from_0deg,transparent,rgb(94_242_194/0.25),transparent_40%)] mix-blend-screen animate-spin-slow" />
