...
/** Final call to action with the reference's ember "sunrise" glow rising from the bottom. */
  ...
  return (
    <section id="contact" aria-labelledby="cta-title" className="px-2 md:px-4">
      <div className="relative isolate overflow-hidden rounded-[2rem] border border-white/[0.06] bg-ink-950 pt-24 pb-44 md:rounded-[3rem] md:pt-32 md:pb-64">
        <div aria-hidden className="absolute inset-x-[-20%] bottom-[-55%] -z-10 h-[120%] rounded-[50%] bg-[radial-gradient(closest-side,#fff7f0_0%,#ffd2b3_12%,#ff7a3d_32%,#ff5a1f_48%,rgb(255_90_31/0.35)_66%,transparent_80%)] md:bottom-[-70%]" />
        <div aria-hidden className="absolute inset-x-0 bottom-0 -z-10 h-1/2 bg-[radial-gradient(60%_100%_at_50%_100%,rgb(255_90_31/0.35),transparent)]" />
        <div className="container-x text-center">
          <Reveal>
            <p className="badge">Next step</p>
          </Reveal>
          <Reveal delay={0.06}>
